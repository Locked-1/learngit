file(REMOVE_RECURSE "/home/wuyulong/cmake-3.13.2/Tests/CMakeTests/uploads")

if(EXISTS "/home/wuyulong/cmake-3.13.2/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/home/wuyulong/cmake-3.13.2/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/home/wuyulong/cmake-3.13.2/Tests/CMakeTests/uploads")

set(filename "/home/wuyulong/cmake-3.13.2/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/home/wuyulong/cmake-3.13.2/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/home/wuyulong/cmake-3.13.2/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/wuyulong/cmake-3.13.2/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/home/wuyulong/cmake-3.13.2/Tests/CMakeTests/uploads/file2.png"
